...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Open the resource
        InputStream insertsStream = ctx.getResources().openRawResource(R.raw.get_it_db);
    ...
    public void generateTable() {
        ...
        System.out.println("$$$$$$$$$$$$$$$");
        db.execSQL("insert into " + table_NAME_user + "(username,password) values('vivek','vivek123')");
        System.out.println("$$$$$$$$$$$$$$$");
        db.close();
    }
