...
/**
 * Created by vIvEk on 07-01-2016.
 */

public class RecordsDBHelper {
    /*  RetrieveRecentActivities db = new RetrieveRecentActivities(this);
      List<Records> list;
...
/*// drop this database if already exists
    ...
    myAdapter = new ArrayAdapter<String>(this, R.layout., R.id.listText, listTitle);
